      ...
      return Column(
        ...
        children: [
          Badge(
            ...
            child: IconButton(
              variance: router.topRoute.name == UserLocalLibraryRoute.name
                  ? ButtonVariance.secondary
                  : ButtonVariance.ghost,
              icon: const Icon(SpotubeIcons.download),
              onPressed: () => context.navigateTo(const UserLocalLibraryRoute()),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          SizedBox(
            ...
            child: Button(
              style: router.topRoute.name == UserLocalLibraryRoute.name
                  ? ButtonVariance.secondary
