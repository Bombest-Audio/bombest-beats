...
class PlayerView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    // Watch the full player state to ensure updates when currentIndex changes
    final playerState = ref.watch(audioPlayerProvider);
    final currentActiveTrack = playerState.activeTrack;
    ...
    // Use currentActiveTrack directly instead of memoizing to ensure updates
    // The dependency on currentActiveTrack ensures it updates when the track changes
    String albumArt = useMemoized(
      () => (currentActiveTrack?.album.images).asUrlString(
        placeholder: ImagePlaceholder.albumArt,
      ),
      [currentActiveTrack], // Depend on the full track object, not just images
    );
