...
class UserPreferencesNotifier extends Notifier<PreferencesTableData> {
  ...
  Future<String> _getDefaultDownloadDirectory() async {
    if (kIsAndroid) return "/storage/emulated/0/Download/BombestBeats";
    ...
    return paths.getDownloadsDirectory().then((dir) {
      return join(dir!.path, "BombestBeats");
    });
  }
  ...
  void setAutoDownloadAll(bool enabled) {
    setData(PreferencesTableCompanion(autoDownloadAll: Value(enabled)));
  }
}
