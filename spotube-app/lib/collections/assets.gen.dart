...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/bomb_logo.png
  AssetGenImage get bombLogo =>
      const AssetGenImage('assets/images/bomb_logo.png');

  /// File path: assets/images/grain.png
  AssetGenImage get grain => const AssetGenImage('assets/images/grain.png');
