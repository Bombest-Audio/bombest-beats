...
enum YoutubeClientEngine {
  ...
  bool isAvailableForPlatform() {
    return switch (this) {
      YoutubeClientEngine.youtubeExplode => true, // Always available (S3/Mock)
      YoutubeClientEngine.ytDlp => false, // Removed
      YoutubeClientEngine.newPipe => false, // Removed
    };
  }
}
...
class PreferencesTable extends Table {
  ...
  TextColumn get accentColorScheme => text()
      .withDefault(const Constant("bombest:0xffe90060"))
  ...
  BoolColumn get autoDownloadAll =>
      boolean().withDefault(const Constant(false))();
  ...
  static PreferencesTableData defaults() {
    return PreferencesTableData(
      ...
      accentColorScheme:
          SpotubeColor(BombestTheme.primary.value, name: "bombest"),
