...
class $PreferencesTableTable extends PreferencesTable
  ...
  late final GeneratedColumnWithTypeConverter<SpotubeColor, String>
      accentColorScheme = GeneratedColumn<String>(
              ...
              type: DriftSqlType.string,
              requiredDuringInsert: false,
              defaultValue: const Constant("bombest:0xffe90060"))
  ...
  late final GeneratedColumn<bool> cacheMusic = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(true));
  static const VerificationMeta _autoDownloadAllMeta =
      const VerificationMeta('autoDownloadAll');
  @override
  late final GeneratedColumn<bool> autoDownloadAll = GeneratedColumn<bool>(
      'auto_download_all', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("auto_download_all" IN (0, 1))'),
      defaultValue: const Constant(false));
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('auto_download_all')) {
      context.handle(
          _autoDownloadAllMeta,
          autoDownloadAll.isAcceptableOrUnknown(
              data['auto_download_all']!, _autoDownloadAllMeta));
    }
    return context;
  }
  ...
  PreferencesTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PreferencesTableData(
      ...
      autoDownloadAll: attachedDatabase.typeMapping.read(
          DriftSqlType.bool, data['${effectivePrefix}auto_download_all'])!,
    );
  }
...
class PreferencesTableData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['auto_download_all'] = Variable<bool>(autoDownloadAll);
    return map;
  }
  ...
  PreferencesTableCompanion toCompanion(bool nullToAbsent) {
    return PreferencesTableCompanion(
      ...
      autoDownloadAll: Value(autoDownloadAll),
    );
  }
  ...
  factory PreferencesTableData.fromJson(Map<String, dynamic> json,
    ...
    return PreferencesTableData(
      ...
      autoDownloadAll: serializer.fromJson<bool>(json['autoDownloadAll']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'autoDownloadAll': serializer.toJson<bool>(autoDownloadAll),
    };
  }
  ...
  PreferencesTableData copyWith(
      ...
      PreferencesTableData(
        ...
        autoDownloadAll: autoDownloadAll ?? this.autoDownloadAll,
      );
  PreferencesTableData copyWithCompanion(PreferencesTableCompanion data) {
    return PreferencesTableData(
      ...
      autoDownloadAll: data.autoDownloadAll.present
          ? data.autoDownloadAll.value
  ...
  String toString() {
    return (StringBuffer('PreferencesTableData(')
          ...
          ..write('autoDownloadAll: $autoDownloadAll')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is PreferencesTableData &&
          ...
          other.autoDownloadAll == this.autoDownloadAll);
}
...
class PreferencesTableCompanion extends UpdateCompanion<PreferencesTableData> {
  ...
  final Value<bool> autoDownloadAll;
  const PreferencesTableCompanion({
    ...
    this.autoDownloadAll = const Value.absent(),
  });
  ...
  static Insertable<PreferencesTableData> custom({
    ...
    Expression<bool>? autoDownloadAll,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      ...
      if (autoDownloadAll != null) 'auto_download_all': autoDownloadAll,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (autoDownloadAll.present) {
      map['auto_download_all'] = Variable<bool>(autoDownloadAll.value);
    }
    return map;
  }
...
class $$PreferencesTableTableFilterComposer
  ...
  ColumnFilters<bool> get autoDownloadAll => $composableBuilder(
      column: $table.autoDownloadAll,
      builder: (column) => ColumnFilters(column));
}
...
class $$PreferencesTableTableOrderingComposer
  ...
  ColumnOrderings<bool> get autoDownloadAll => $composableBuilder(
      column: $table.autoDownloadAll,
      builder: (column) => ColumnOrderings(column));
}
...
class $$PreferencesTableTableAnnotationComposer
  ...
  GeneratedColumn<bool> get autoDownloadAll => $composableBuilder(
      column: $table.autoDownloadAll, builder: (column) => column);
}
  ...
  $$PreferencesTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<bool> autoDownloadAll = const Value.absent(),
          }) =>
