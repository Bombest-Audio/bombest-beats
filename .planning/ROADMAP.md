...
Plans:
- [ ] 08-01-PLAN.md — AVAudioEngine FFT pipeline + A-B loop state + Haptic Groove Engine (Wave 1)
- [ ] 08-02-PLAN.md — APIService Cloudflare→EC2 failover + LoadState error recovery for all data screens (Wave 1)
- [ ] 08-03-PLAN.md — FavoritesManager + TrackRow heart toggle + LibraryView indicator (Wave 1)
- [ ] 08-04-PLAN.md — A-B loop UI in PlayerView + real visualizer wiring (Wave 2, depends 08-01)
