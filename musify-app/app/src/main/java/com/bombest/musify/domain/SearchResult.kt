package com.bombest.musify.domain

import android.content.Context
import com.bombest.musify.utils.generateMusifyDateAndDurationString
...
sealed class SearchResult {
     ...
     * [albumName] is optional and used for display (e.g. in Library subtitle).
     * [backendTrackId] is set when this track is matched to the backend library
     * (by S3 key/path); when non-null, in-app metadata editing is available.
     */
    data class TrackSearchResult(
        ...
        override val streamInfo = StreamInfo(
            ...
            title = name,
            subtitle = albumName ?: artistsString
        )
    }
