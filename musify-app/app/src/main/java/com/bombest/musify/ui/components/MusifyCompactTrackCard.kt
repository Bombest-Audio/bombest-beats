 ...
 * track. This is a wrapper over [com.bombest.musify.ui.components.MusifyCompactListItemCard].
...
fun MusifyCompactTrackCard(
    ...
    onEditMetadataClick: ((SearchResult.TrackSearchResult) -> Unit)? = null,
    showEditMetadataButton: Boolean = (onEditMetadataClick != null && track.backendTrackId != null)
) {
    ...
    CompositionLocalProvider(
        ...
        MusifyCompactListItemCard(
            ...
            title = track.name,
            subtitle = track.albumName ?: track.artistsString,
            onClick = { onClick(track) },
            onTrailingButtonIconClick = if (onEditMetadataClick != null) ({ onEditMetadataClick(track) }) else ({ }),
            showTrailingIconButton = showEditMetadataButton,
            ...
            trailingContent = if (downloadManager != null && onDownloadClick != null) {
                {
