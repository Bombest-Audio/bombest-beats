package com.bombest.musify.viewmodels.homefeedviewmodel
...
import com.bombest.musify.data.repositories.homefeedrepository.ISO6391LanguageCode
import com.bombest.musify.data.utils.FetchedResource
import com.bombest.musify.di.BombestBeatsApplication
import com.bombest.musify.domain.*
...
class HomeFeedViewModel @Inject constructor(
    ...
    private fun fetchAndAssignHomeFeedCarousels() {
        viewModelScope.launch {
            ...
            val languageCode =
                getApplication<BombestBeatsApplication>().resources.configuration.locale.language.let(::ISO6391LanguageCode)
